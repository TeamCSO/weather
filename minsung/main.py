...
# joblib.dump(tr.models_lgb, dir_path + '/data/model/in_tmp_model_lgb.pkl')
# joblib.dump(tr.models_xgb, dir_path + '/data/model/in_tmp_model_xgb.pkl')

# tr.train_lgb(train_X_2, train_Y_2, params['lgb'])
# tr.train_xgb(train_X_2, train_Y_2, params['xgb'])
# joblib.dump(tr.models_lgb, dir_path + '/data/model/in_hum_model_lgb.pkl')
# joblib.dump(tr.models_xgb, dir_path + '/data/model/in_hum_model_xgb.pkl')

tr.train_lgb(train_X_3, train_Y_3, params['lgb'])
tr.train_xgb(train_X_3, train_Y_3, params['xgb'])
joblib.dump(tr.models_lgb, dir_path + '/data/model/heat_supply_model_lgb.pkl')
joblib.dump(tr.models_xgb, dir_path + '/data/model/heat_supply_model_xgb.pkl')

pred1 = pred.predict_lgb(tr.models_lgb, train_X_3)
pred2 = pred.predict_xgb(tr.models_xgb, train_X_3)
